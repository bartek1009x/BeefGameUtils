...
public class OrientedBoundingBox {
	private static Vector3[] tempAxes = new Vector3[15];
	...
	public this(BoundingBox bounds, Matrix4 transform) {
		this.bounds.set(bounds.min, bounds.max);
