...
public class FitViewport : ScalingViewport {
	...
	public this (float worldWidth, float worldHeight) : base(Scaling.fit, worldWidth, worldHeight) {}

	public this (float worldWidth, float worldHeight, Camera camera) : base(Scaling.fit, worldWidth, worldHeight, camera) {}
}