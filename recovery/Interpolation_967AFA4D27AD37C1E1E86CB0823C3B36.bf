...
public abstract class Interpolation {
	...
	static public readonly Interpolation linear = new Interpolation() {
	...
	/** Aka "smoothstep". */
	static public readonly Interpolation smooth = new Interpolation() {
		public float apply (float a) {
			return a * a * (3 - 2 * a);
		}
	};
	static public readonly Interpolation smooth2 = new Interpolation() {
		public float apply (ref float a) {
			a = a * a * (3 - 2 * a);
			return a * a * (3 - 2 * a);
		}
	};
	...
	/** By Ken Perlin. */
	static public readonly Interpolation smoother = new Interpolation() {
		public float apply (float a) {
	...
	static public readonly Interpolation pow2InInverse = new Interpolation() {
		public float apply (float a) {
			if (a < MathUtils.FLOAT_ROUNDING_ERROR) return 0;
			return (float)Math.Sqrt(a);
		}
	};
	static public readonly Interpolation pow2OutInverse = new Interpolation() {
		public float apply (float a) {
			if (a < MathUtils.FLOAT_ROUNDING_ERROR) return 0;
			if (a > 1) return 1;
	...
	static public readonly Interpolation pow3InInverse = new Interpolation() {
		public float apply (float a) {
			return (float)Math.Cbrt(a);
		}
	};
	static public readonly Interpolation pow3OutInverse = new Interpolation() {
		public float apply (float a) {
	...
	static public class PowOut : Pow {
		public this(int power) {
			super(power);
		}
	...
	static public class Exp : Interpolation {
		float value, power, min, scale;

		public this(float value, float power) {
			this.value = value;
			this.power = power;
	...
	static public class ExpOut : Exp {
		public this(float value, float power) {
			super(value, power);
		}
	...
	static public class Elastic : Interpolation {
		final float value, power, scale, bounces;

		public this(float value, float power, int bounces, float scale) {
			this.value = value;
			this.power = power;
			this.scale = scale;
	...
	static public class ElasticIn : Elastic {
		public this(float value, float power, int bounces, float scale) {
	...
	static public class ElasticOut : Elastic {
		public this(float value, float power, int bounces, float scale) {
			super(value, power, bounces, scale);
		}
	...
	static public class Bounce : BounceOut {
		public this(float[] widths, float[] heights) {
			super(widths, heights);
		}

		public this(int bounces) {
			super(bounces);
		}
	...
	static public class BounceOut : Interpolation {
	...
	static public class BounceIn : BounceOut {
	...
	static public class Swing : Interpolation {
	...
	static public class SwingOut : Interpolation {
		private final float scale;
	...
	static public class SwingIn : Interpolation {
		private final float scale;
